...
public class BlogConfigConstant {
    ...
    public static final String yourEmail = "2607840393@qq.com";
    public static final String yourName = "silence";
